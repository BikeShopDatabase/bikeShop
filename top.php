...
<html lang="en">
    <head>
        <title>J&B Bikes</title>
        <meta charset="utf-8">
        <meta name="author" content="Josh Dyke">
        <meta name="description" content="Final Project.  This is a database that could be used for existing bike shops">
        ...
        <link rel="shortcut icon" href="bin/thumbnail.gif"/>
        ...
        $dbUserName = 'jrdyke_writer';
        $whichPass = "w";
        $thisDatabaseWriter = new Database($dbUserName, $whichPass, $dbName);
        
        $dbUserName = 'jrdyke_admin';
        $whichPass = "a";
        ...
        if ($path_parts['filename'] == "viewBike") {
            include "lib/validation-functions.php";
            include "lib/mail-message.php";
        }
